<template>
  <div
    class="code-input bg-[#f3f4f6] w-[90%] h-fit grid grid-cols-[2.5fr_1fr_1.3fr] rounded-b-[6px_6px]"
  >
    <input
    ...
    <div class="flex justify-center items-center">
      <img
        ...
        v-bind:src="CaptchaLink"
        alt="captcha"
        @click="GetCaptcha"
      />
    </div>
    <label class="flex justify-center items-center" for="code-input"
      >کد امنیتی</label
    >
  </div>
</template>
