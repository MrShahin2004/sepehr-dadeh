          ...
          <div class="flex gap-6 h-full">
            ...
            <div class="w-64 bg-[#48b3bd] rounded-lg p-4 text-white">
              ...
              <div class="space-y-3">
                ...
                >
                  <span class="text-sm"
                    >انعقاد قرارداد خدمات پشتیبانی مدارس</span
                  >
                </div>
                <div
                  class="flex justify-end items-center gap-2 p-2 bg-white/10 rounded"
                ...
                >
                  <span class="text-sm"
                    >سامانه مدیریت قراردادها (نسخه جدید)</span
                  >
                </div>
                <div
                  class="flex justify-end items-center gap-2 p-2 bg-white/10 rounded"
...
export default {
  ...
  methods: {
    ...
    simulateDownload(id) {
      toast.success(
        `درخواست دریافت فایل قرارداد (شناسه: ${id}) به سرور ارسال شد.`,
        {
          autoClose: 3000,
