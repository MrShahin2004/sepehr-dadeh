<template>
  ...
  >
    <div class="agreement-container w-[95%] h-[100%] flex justify-around gap-4">
      <div
          class="announcement-container w-[25%] h-[460px] rounded-xl bg-[var(--body-bg)] flex justify-center items-center"
      >
        <div
      ...
      <div
          class="agreement-list-container w-[60%] h-[460px] rounded-xl bg-[var(--body-bg)] relative overflow-y-hidden"
      >
        <h2
            style="padding: 1rem"
      ...
      <div
          class="agreement-search-container w-[25%] h-[460px] rounded-xl bg-[var(--body-bg)] flex justify-center items-center"
      >
        <div
